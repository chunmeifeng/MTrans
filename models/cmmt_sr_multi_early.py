...
def build_head(args):
    return ReconstructionHead(args.MODEL.INPUT_DIM, args.MODEL.HEAD_HIDDEN_DIM//2)
...
class CMMT(nn.Module):
    ...
    def __init__(self, args):
        ...
        self.up = nn.Sequential(
            Upsampler(conv, args.SCALE, args.MODEL.HEAD_HIDDEN_DIM//2, act=False),
            conv(args.MODEL.HEAD_HIDDEN_DIM//2, args.MODEL.HEAD_HIDDEN_DIM//2, 3))
