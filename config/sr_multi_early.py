...
# the others config
_C.RESUME = ''
# _C.RESUME = 'weights_SR_multi_early_singlecoil_test/checkpoint0001.pth'  # model resume path
_C.OUTPUTDIR = './weights_SR_multi_early_50_lrplus'  # the model output dir
_C.TEST_OUTPUTDIR = 'outputs/sr_multi_early'
